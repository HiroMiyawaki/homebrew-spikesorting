...
class Ndmanager < Formula
  ...
  def install
   ...
   inreplace 'src/ndmanagerdoc.cpp','QString path = QStandardPaths::locate (QStandardPaths::ApplicationsLocation, QLatin1String("ndmanager/ndManagerDefault.xml"))', 'QString path = QStandardPaths::locate (  QLatin1String("/usr/local/share/ndmanager/ndManagerDefault.xml"))'
